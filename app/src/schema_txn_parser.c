...
parser_error_t schema_display_enum(parser_context_t *ctx, parser_tx_t *txObj) {
    ...
    CHECK_ERROR(read_enum(&txObj->merkle_proof.leaves.data, &enum_type));
    CHECK_ERROR(schema_reset_leaf_offset(&txObj->merkle_proof.leaves));
...
parser_error_t schema_display_struct(parser_context_t *ctx, parser_tx_t *txObj) {
    ...
    CHECK_ERROR(read_struct(&txObj->merkle_proof.leaves.data, &struct_type));
    CHECK_ERROR(schema_reset_leaf_offset(&txObj->merkle_proof.leaves));
...
parser_error_t schema_display_tuple(parser_context_t *ctx, parser_tx_t *txObj) {
    ...
    CHECK_ERROR(read_tuple(&txObj->merkle_proof.leaves.data, &tuple_type));
    CHECK_ERROR(schema_reset_leaf_offset(&txObj->merkle_proof.leaves));
...
parser_error_t schema_display_option(parser_context_t *ctx, parser_tx_t *txObj) {
    ...
    CHECK_ERROR(read_option(&txObj->merkle_proof.leaves.data, &option_type));
    CHECK_ERROR(schema_reset_leaf_offset(&txObj->merkle_proof.leaves));
...
parser_error_t schema_display_array(parser_context_t *ctx, parser_tx_t *txObj) {
    ...
    CHECK_ERROR(read_array(&txObj->merkle_proof.leaves.data, &array_type));
    CHECK_ERROR(schema_reset_leaf_offset(&txObj->merkle_proof.leaves));
...
parser_error_t schema_display_vec(parser_context_t *ctx, parser_tx_t *txObj) {
    ...
    CHECK_ERROR(read_link(&txObj->merkle_proof.leaves.data, &vec_type.value));
    CHECK_ERROR(schema_reset_leaf_offset(&txObj->merkle_proof.leaves));
